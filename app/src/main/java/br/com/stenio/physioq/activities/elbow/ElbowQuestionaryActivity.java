package br.com.stenio.physioq.activities.elbow;
...
public class ElbowQuestionaryActivity extends AppCompatActivity implements RecyclerViewOnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar();
        setupRecyclerView();
        ankleQuestionariesNames = Arrays.asList(getResources().getStringArray(R.array.elbow_questionaries));
        ...
        ibBack.setOnClickListener(new View.OnClickListener()

                                  {
                                      ...
                                      public void onClick(View v) {
                                          Intent intent = new Intent(ElbowQuestionaryActivity.this, HomeActivity.class);
...
//chave do onCreate
    ...
    public void setupToolbar() {
        ...
        mToolbar.setTitle(R.string.elbow);
    ...
    public void onClickListener(int position) {
        ...
        switch (position) {
            case 0: openQuestionary = new Intent(ElbowQuestionaryActivity.this, Dados.class);
        ...
        startActivityForResult(openQuestionary,CONSTANTE_TELA_2);
    }
}
